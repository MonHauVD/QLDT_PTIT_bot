...
public class Crawl_updateFromQLDT {
    private ListUser2 listUser;
    private Long chatId;

    public Crawl_updateFromQLDT() 
    {
    }

    public Crawl_updateFromQLDT(ListUser2 listUser, Long chatId) 
    {
...
//        System.out.println("Crawl_DiemGPA: " + Ans[0].toString());
    ...
    public static void main(String[] args) {
        ...
        Crawl_updateFromQLDT crawl = new Crawl_updateFromQLDT(lsUser2, 1L);
