 ...
 * @author DELL
 */
public class Crawl_DiemGPATheoHocKy {
    private String qldtUsername;
    private String qldtPassword;
    private String year;
    private String semester;

    public Crawl_DiemGPATheoHocKy() {
    }

    public Crawl_DiemGPATheoHocKy(String qldtUsername, String qldtPassword, String year, String semester) {
                    ...
                    {                       
                        ...
                        for(int i = 0; i < dsDiemHocKyArray.length(); i++) 
                        {
                            ...
                            if(hocKy.getString("hoc_ky").equals(yearSemester)) {
                                ...
                                {                                 
                                    Ans[0].append("Điểm GPA của học kỳ " + semester + " năm học " + year + " chưa được cập nhật!\n");                                   
                                } else
                                {
                                   Ans[0].append("Điểm GPA của học kỳ " + semester + " năm học " + year + ": " + hocKy.getDouble("dtb_hk_he4") + "\n"); 
                                }                                
                            }
                        ...
                        if(ok == 0) {
                            Ans[0].append("Không tìm thấy học kỳ " + semester + " năm học " + year + " !\n"); 
                        }
                    }
...
//        System.out.println("Crawl_DiemGPA: " + Ans[0].toString());
    ...
    public static void main(String[] args)
    {
        ...
        Crawl_DiemGPATheoHocKy crawl = new Crawl_DiemGPATheoHocKy("B21DCCNXXX", "12345", "2023-2024", "2");
